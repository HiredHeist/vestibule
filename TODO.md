...
- [x] **DOUBLE TIME tier-3 description — FIXED (cfdfc7a) + 3rd copy fix needed.** The Opening Night band-abilities glossary at line ~4663 still says "At 3+ stacks, ALL members attack twice this Strike" — confirmed visible in browser test. Need to update that third source location.
