...
**Latest: ae99e12 | March 25, 2026 JST**
...
- [ ] **Damage Breakdown Animation** — Balatro-style number-go-up spectacle after every Strike. Base ATK ticks up per member → multiplier applies with shake → genre/mentor/combo bonuses flash → final number SLAMS. Currently damage just happens silently. This is THE #1 addiction hook.
...
- [ ] **Post-Run Highlights** — "You were 2 strikes from beating the Archfraud. Try again?" + biggest strike, closest call, longest combo chain. Loss aversion is the most powerful Play Again trigger.
- [ ] **End Screen Stats Bigger** — Individual stat boxes, screenshot-worthy layout. Current stats are small and forgettable.
