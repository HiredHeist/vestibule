...
// 0 ATK and provide the BLASTBEAT band multiplier (x1.35/drummer) instead. They used to
...
// is a genuine trade — an attacker slot for a x1.35 band buff — and the veteran bot picks
...
export const ALL_MUSICIANS=[
  ...
  // BLASTBEAT: multiple drummers are allowed and their ×1.35 band damage STACKS (×1.82 for
  ...
  {id:'thor',name:'Thor',role:'Drummer',atk:0,hp:14,maxHp:14,emoji:'🥁',keyword:'BLASTBEAT',desc:'Relentless double-kick. Drummers make the whole band hit ×1.35 — swing nothing themselves, so protect them and stack for combos.',bio:'Not THAT Thor. This one is louder. Broke three drum kits in one show. The venue banned drums after that.'},
  ...
  // Aug 5 2026 — Rolf stays BLASTBEAT (renamed from DOUBLE TIME). Flat ×1.35 band damage,
  // no dice. Rolf is the lighter-bodied drummer (hp 11) next to Thor (hp 14).
  {id:'rolf',name:'Rolf',role:'Drummer',atk:0,hp:11,maxHp:11,emoji:'🥁',keyword:'BLASTBEAT',desc:'Precision tempo. The whole band hits ×1.35 harder — reliable, every strike. Lighter body than Thor; keep him alive.',bio:'A mathematician who discovered the optimal striking frequency. Each hit is precisely calculated for maximum devastation.'},
