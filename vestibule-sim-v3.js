...
const ALL_CARDS=[
  ...
  {id:'amp',type:'RIFF',rarity:'Common',embers:2,copies:3},
  ...
  {id:'soundwall',type:'RIFF',rarity:'Uncommon',embers:2,copies:2},
  ...
  {id:'infencore',type:'RIFF',rarity:'Rare',embers:3,copies:2},
  {id:'stagedive',type:'RIFF',rarity:'Rare',embers:4,copies:1},
  {id:'possessedperf',type:'RIFF',rarity:'Rare',embers:4,copies:2},
  {id:'doubledown',type:'RIFF',rarity:'Uncommon',embers:1,copies:1},
  // ═══ EMBER (9) ═══
  {id:'powertap',type:'EMBER',rarity:'Common',embers:0,copies:3},
  ...
  {id:'sigdecay',type:'CORRUPT',rarity:'Common',embers:1,copies:2},
  ...
  {id:'ampstatic',type:'CORRUPT',rarity:'Uncommon',embers:2,copies:1},
  {id:'bloodritual',type:'CORRUPT',rarity:'Rare',embers:2,copies:1},
  // ═══ UTILITY (11) ═══
  {id:'roadie',type:'UTILITY',rarity:'Common',embers:1,copies:3},
  ...
  {id:'soundcheck',type:'UTILITY',rarity:'Common',embers:2,copies:1},
  {id:'remaster',type:'UTILITY',rarity:'Rare',embers:0,copies:1},
  // ═══ SHOP-ONLY ═══
  {id:'sabbathsigil',type:'CORRUPT',rarity:'Rare',embers:2,copies:1,shopOnly:true,consumable:true},
  {id:'overdrive',type:'RIFF',rarity:'Rare',embers:2,copies:1,shopOnly:true},
  {id:'goingbroke',type:'RIFF',rarity:'Rare',embers:0,copies:1,shopOnly:true},
  {id:'controlfeedback',type:'CORRUPT',rarity:'Uncommon',embers:2,copies:1,shopOnly:true},
  {id:'contract',type:'CORRUPT',rarity:'Rare',embers:0,copies:1,shopOnly:true},
];
...
function _scoreCardBase(card,gs,enemy,strikeNum,cardsPlayed){
  ...
  switch(card.id){
    ...
    case 'soundboard':return embers<=3?60:28;case 'setbreak':return embers<=2?58:32;
    ...
    case 'distortion':return 57;case 'dialtoeleven':return corruption<50?55:20;
    ...
    case 'setlist':return hand.length<=4?50:20;
...
function applyCardSim(card,gs,enemy){
  ...
  switch(card.id){
    ...
    case 'dialtoeleven':gs.corruption=Math.min(100,gs.corruption+5);gs.stage.forEach(m=>{if(!m.tooStoned){m.atk+=2;m.tempAtkBonus=(m.tempAtkBonus||0)+2}});break;
